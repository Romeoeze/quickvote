...
@section('content')
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form id="contestantAddForm" data-parsley-validate method="post"
                                                    ...
                                                    <div class="row"
                                                        ...
                                                        <div class="col-md-6" style="padding-top: 25px;">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div>
                                                                    <textarea placeholder="...optional. If available, input the bio of the contestant. " class="form-control" rows="8"
                                                                        name="bio[]" required="" data-parsley-minlength="40" data-parsley-trigger="keyup"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div style="visibility: hidden;">
                    ...
                    <div class="row"
                        ...
                        <div class="col-md-4" style="padding-top: 25px;">
                            ...
                            <input id="contestant_image" class="form-control" type="file" name="contestant_image[]"
                                required="" data-parsley-filemaxmegabytes="2" data-parsley-trigger="change"
                                data-parsley-filemimetypes="image/jpeg, image/png" accept="image/*" />
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <textarea placeholder="...optional. If available, input the bio of the contestant. " required=""
                                        class="form-control" rows="8" name="bio[]" required="" data-parsley-trigger="keyup"
                                        data-parsley-minlength="40"></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            //     var fileInput = document.getElementById('contestant_image');
