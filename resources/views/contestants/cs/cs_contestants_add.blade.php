                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" action="{{ route('corporatesinglecontestant.store') }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select class="form-select" name="contest_id" required>
                                                                <option value="" selected="" disabled="">Select Contest Name
                                                                </option>
                ...
                <div class="row">
                    ...
                    <div class="row"
                        ...
                        <div class="col-md-4" style="padding-top: 25px;">
                            ...
                            <label for="company_logo">Upload Contestant Picture</label>
                            <input id="contestant_image" class="form-control" type="file" name="contestant_image[]" /><br>
