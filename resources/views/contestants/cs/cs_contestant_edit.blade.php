...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-8">
                <h2> <span style="color:orangered;">Edit Contestant:</span> {{ $contestant->contest->contest_name }}
                </h2>
            </div>
            ...
            <div class="col-4">
                <div class="box mb-8 mr-6 col-md-8">
                    ...
                    <a href="{{ route('corporatesinglecontest.all') }}" style="float: right;"
                        class="btn btn-rounded btn-success"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
                    </a>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('corporatesinglecontestant.update', $contestant->id) }}"
                                    method="POST" id="ContestantEditForm" data-parsley-validate
