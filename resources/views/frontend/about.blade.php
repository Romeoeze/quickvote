            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-lg-7 col-xl-6">
                    <div class="mb-8 withpad">
                        <h3 class="font-w-9 mb-4">About Quickvote.ng</h3>
                        <!-- Section description -->
                        <p class="text-muted w-responsive mx-auto mb-5">QuickVote is an efficient voting system that allows
                            event organizers to set-up their PAID OR FREE contests for their events. Our product gives a
                            wide range of local and global users the opportunity to participate and cast their votes
                            effortlessly from any part of the world.</p>
                        ...
                        <div class="col-lg-6 col-md-6 withpad">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        Voting results are published immediately after voting ends, so our system is ideal
                                        for voting during meetings, instant polls at conferences, or a quick second round of
                                        voting in the event of a tie.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-6 mt-md-0 withpad">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Your results are safe and always available real time in graphs and
                                        charts. our pages are secured with 256bit SSL encryption,no one can tamper with your
                                        results</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-6 withpad">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">You can easily setup your poll Contests with your category, add your
                                        own contestants or partcicipants and also the amount for paid votes.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-6 withpad">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Our system is optimized for desktop and mobile devices. Voters can
                                        vote from a PC web browser or browsers on mobile devices.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="column">
            <div class="pricing-card pro">
                ...
                <div class="buy-button-box">
                    <a href="{{ route('contest.create') }}"><button class="sc-button style letter style-2"><span>Create Paid
                                Contest</span> </button></a>
                </div>
            </div>
            <br><br>
        </div>
            ...
            <div class="pricing-card eco">
                ...
                <div class="buy-button-box">
                    <a href="{{ route('contest.create') }}"><button class="sc-button style letter style-2"><span> Create
                                Freemium Contest</span> </button></a>
                </div>
            </div>
        </div>
