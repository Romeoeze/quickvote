                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="sc-product-item style-2 badgee">
                                ...
                                <div class="product-content">
                                    ...
                                    @foreach ($con->contestants->chunk(3) as $com)
                                        <div class="row">
                                            @foreach ($com as $co)
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="sc-product-item style-2 badgee">
                                                        <div class="product-img">
                                                            <a
                                                                href="{{ route('corporatemulticontestcontestant.user.vote', $co->slug) }}">
                                                                <img src="{{ asset($co->image) }}" alt="Image"></a>
                                                            <a href="{{ route('corporatemulticontestcontestant.user.vote', $co->slug) }}"
                                                        ...
                                                        <div class="product-content">
                                                            <h5 style="text-align: center; padding:30px; font-size:25px;"><a
                                                                    href="{{ route('corporatemulticontestcontestant.user.vote', $co->slug) }}">{{ $co->name }}</a>
                                                            </h5>
