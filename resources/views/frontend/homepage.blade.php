...
<section>
  <div class="container">
    ...
    <div class="row align-items-center">
            <div class="col-10 order-lg-2 order-sm-1 col-sm-6 mb-8 mb-lg-0">
              <!-- Image -->
              <img src="{{ (!empty($sliderData->image))? asset($sliderData->image):url('uploads/no_image.jpg') }}" alt="Quickvote" width="900">
            ...
            <div class="col-2 col-sm-6">
                    ...
                    <!-- Text -->
                        ...
                        <p class="lead text-muted">{{ $sliderData->description }}</p>
                    ...
                    <a href="/register" class="btn btn-outline-primary home2">
                            Get Started
                              ...
                              <div class="container trlogo"><br><h6 style="letter-spacing: 2px;font-size: 10px;opacity: 0.6;padding-left: 14px;">TRUSTED BY GREAT BRANDS IN NIGERIA</h6>
                                      ...
                                      @foreach ($brands as $b)
                                          <div class="slide"><img src="{{asset($b->logos)}}"></div>
                                   @endforeach
