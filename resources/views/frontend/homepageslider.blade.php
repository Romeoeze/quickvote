    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8 justify-content-center align-self-center">
                ...
                <div class="card-body"> <h3>Edit Slider Profile</h3>
                    ...
                    @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="description" class="form-control" type="text" name="description" value="{{$sliderData ->description }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10"> 
                                <img class="img-thumbnail rounded-circle avatar-xl" id="showImage" src="{{(!empty($sliderData->image)) ? url($sliderData->image) : 
