                                ...
                                <div class="form-create-item-content">
                                    <div class="form-create-item">
                                        ...
                                        <div class="sc-heading" style="padding-right: 40px;"><br><br>
                                            ...
                                            <h6>Category: <span
                                                    style="color:rgb(216, 71, 19)">{{ $contestant->category->category_name }}</span>
                                            </h6><br><br>
                                            ...
                                            <div class="new">
                                                ...
                                                <p><a href="{{ route('multicontest.user.view', $contestant->category->contest->slug) }}"
                                        ...
                                        <form id="create-item-1" action="{{ route('pay') }}" method="POST">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="num2" name="num2"
                                                    value="{{ $contestant->category->vote_price }}" type="number"
                                                    placeholder="Price per Vote: ₦{{ $contestant->category->vote_price }}"
                                                    readonly>
                                            </div>
                                            ...
                                            <input class="pricepervote" type="hidden" name="pricepervote"
                                                value="{{ $contestant->category->vote_price }}">
                                            ...
                                            <input type="hidden" name="metadata"
                                                value="{{ json_encode(
                                                    $array = [
                                                        ...
                                                        'contest_id' => $contestant->category->contest->id,
                                                        'pricepervote' => $contestant->category->vote_price,
                                                        'contest_type' => 'multi',
                                                    ],
                                                ) }}">
