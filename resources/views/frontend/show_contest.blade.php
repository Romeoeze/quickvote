                ...
                <div class="col-xl-6 col-lg-12 col-md-12">
                    <div class="content-item"><br><br>
                        ...
                        <div class="author-item">
                            <div class="">
                                <img src="{{ asset('uploads/vendors/' . $contests->vendor->company_logo) }}" width="80px"
                ...
                <div class="row">
                    <div class="col-md-9">
                        <center>
                            ...
                            <form method="post" action="{{ route('contestant.user.search') }}">
                                @csrf
                                <div class="input-group" id="create-item-1">

                                    <select name="contestants">
                                        <option value="">---Select Contestant---</option>
                                        @foreach ($contests->contestants as $contestant)
                                            <option value="{{ $contestant->id }}">{{ $contestant->name }} -
                                                ID: {{ $contestant->passcode }}</option>
                                        @endforeach
                    ...
                    <div class="col-md-3">
                        <button name="submit" type="submit" class="sc-button style letter style-2"
                            style="margin-top:5px;"><span style="font-size:18px; line-height:30px;">Find
                                Contestant</span> </button>
                    </div>
                    </form>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="sc-product-item style-2 badgee">
                                <div class="product-img">
                                    <a href="{{ route('contestant.user.vote', $con->slug) }}"> <img
                                            src="{{ asset($con->image) }}" alt="Image"></a>
                                    <a href="{{ route('contestant.user.vote', $con->slug) }}"
                                ...
                                <div class="product-content">
                                    <h4 style="text-align: center; padding:30px; font-size:25px; "><a
                                            href="{{ route('contestant.user.vote', $con->slug) }}">{{ $con->name }}</a>
                                    </h4>
