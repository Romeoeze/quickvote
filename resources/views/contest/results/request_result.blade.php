            ...
            <div class="row">
                ...
                <div class="col-md-5 border-right"> <br>
                    ...
                    @if (count($all_contests))
                        <form id="requestPayout" data-parsley-validate action="{{ route('result.search') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="p-3 py-5">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="text-right">Check Result</h4><br>
                                    <img width="130" src="{{ asset('images/result.png') }}" alt="">
                                </div>
                                <div class="row mt-2">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('select[name="category_id"]').on('change', function() {
                ...
                if (category_id) {
                    $.ajax({
                        url: "{{ url('/vendor/contest/result/ajax') }}/" + category_id,
                        type: "GET",
                        dataType: "json",
