        ...
        <div class="container rounded bg-white mt-5 mb-5" style="padding: 30px;">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top img-fluid" src="{{ asset('uploads/board.jpeg') }}" alt="Card image cap">
                            <div class="card-body">
                                <h2 class="card-title" style="font-weight:900; font-size:26px;color:rgb(173, 108, 24);">
                                    Single
                                    Category Contest
                                </h2>
                                <p class="card-text">Election/Contest <b>has just One (1)</b>
                                    Category. All listed contestants are competing for the position.
                                </p>
                                <p class="card-text"><span
                                        style="font-weight:900; color:rgb(100, 93, 91); margin-top:-10px;">Example:
                                        Board Chairman Election</span>
                                </p>
                                <a href="{{ route('corporatesinglecontest.add') }}"><button type="button"
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top img-fluid" src="{{ asset('uploads/group.jpeg') }}"
                                alt="Card image cap">
                            <div class="card-body">
                                <h2 class="card-title" style="font-weight:900; font-size:26px; color:rgb(8, 8, 8)">
                                    Multi Category Contest
                                </h2>
                                <p class="card-text">Election/Contest <b>has different
                                        Categories.</b> All listed contestants are competing for different positions
                                    depending on
                                    each
                                    category.
                                </p>
                                <p class="card-text"><span style="font-weight:900; color:rgb(100, 93, 91)">Example:
                                        Committe Excos Election</span>
                                </p> <a href="{{ route('corporatemulticontest.create') }}"><button type="button"
