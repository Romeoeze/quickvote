        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="box mb-8 mr-6 col-md-8">
                    ...
                    <a href="{{ route('contest.create') }}" style="float: right;" class="btn btn-rounded btn-success"> Add
                        Contest <i class="ri-add-circle-fill"></i></a>
                                    ...
                                    <tbody>
                                        @foreach ($contests as $key => $contest)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset($contest->contest_image) }}" alt="" width="100px">
                                                </td>
                                                <td><a href="{{ route('corporatesinglecontest.show', $contest->slug) }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('corporatesinglecontest.show', $contest->slug) }}"
                                                        class="btn btn-warning">View</a>
                                                    <a href="{{ route('corporatesinglecontest.edit', $contest->id) }}"
