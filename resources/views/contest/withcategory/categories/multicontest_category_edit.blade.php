                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" id="CatgoryEditForm" data-parsley-validate
                                    action="{{ route('multicontestcategory.update', $category->id) }}"
                                                ...
                                                <div class="row"
                                                    ...
                                                    <div class="col-md-6" style="padding-top: 25px;">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="col-md-12"><label class="labels">Price
                                                                    Per Vote</label><input type="number"
                                                                    class="form-control" value="{{ $category->vote_price }}"
                                                                    placeholder="eg: 100" name="vote_price" required="">
                                                            </div><br>
