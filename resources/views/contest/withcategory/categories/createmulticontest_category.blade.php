                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form id="CatgoryAddForm" data-parsley-validate method="post"
                                    action="{{ route('multicontestcategory.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="add_item">
                                                    ...
                                                    <div class="row"
                                                        ...
                                                        <div class="col-md-6" style="padding-top: 25px;">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="col-md-12"><label class="labels">Price Per
                                                                        Vote</label><input type="number"
                                                                        class="form-control" value="{{ old('vote_price') }}"
                                                                        placeholder="eg: 100" name="vote_price[]" required=""></div><br>
                    ...
                    <div class="row"
                        ...
                        <div class="col-md-6" style="padding-top: 25px;">
                            <div class="col-md-6" style="padding-top: 25px;">
                                ...
                                <div class="col-md-12"><label class="labels">Price Per Vote</label><input type="number"
                                        class="form-control" value="{{ old('vote_price') }}" placeholder="eg: 100"
                                        name="vote_price[]" required=""></div><br>

                                <div class="col-md-6>
                                        <label
                                            class="
                                    labels">Currency</label>
                                    <input type="text" class="form-control" value="Nigerian Naira (₦)" readonly />
                                </div>
