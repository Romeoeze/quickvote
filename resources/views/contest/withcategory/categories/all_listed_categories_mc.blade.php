                                        ...
                                        <tbody>
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>{{ $category->vote_price }}</td>



                                                    <td>
                                                        <a href="{{ route('multicontestcategory.edit', $category->id) }}"
                                                            class="btn btn-info"><i class="ri-edit-box-line"></i>
                                                            Edit</a>
                                                        <a id="delete"
                                                            href="{{ route('multicontestcategory.delete', $category->id) }}"
