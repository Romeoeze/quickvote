                                    ...
                                    <tbody>
                                        @foreach ($contests as $key => $contest)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('corporatemulticontest.show', $contest->slug) }}"><img
                                                ...
                                                <td>
                                                    <a href="{{ route('corporatemulticontest.show', $contest->slug) }}"
                                                        class="btn btn-warning">View</a>
                                                    <a href="{{ route('corporatemulticontest.edit', $contest->id) }}"
