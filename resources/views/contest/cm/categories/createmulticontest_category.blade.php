                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" action="{{ route('multicontestcategory.store') }}"
                                            ...
                                            <div class="add_item">
                                                ...
                                                <div class="form-group">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-select" name="multicontest_id" required>
                                                        ...
                                                        <div class="col-md-6" style="padding-top: 25px;">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="col-md-12"><label class="labels">Price Per
                                                                        ...
                                                                        placeholder="eg: 100" name="vote_price[]"></div><br>
