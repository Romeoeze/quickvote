        ...
        <div class="container-full">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <a href="{{ route('corporatemultivoter.all') }}" style="float: right;" class="btn btn-rounded btn-info">All
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" id="VoterAddForm" data-parsley-validate
                                    action="{{ route('corporatemultivoter.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="add_item">
