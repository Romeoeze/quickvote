                                ...
                                <div class="mt-3">
                                    @if ($contest->status == '1')
                                        <p><span class="badge rounded-pill bg-success text-white">Contest Verified &
                                                Active</span></p>
                                        <p><a target="_blank"
                                                style="text-decoration: underline !important; color:rgb(69, 129, 9); font-weight:bold;"
                                                href="{{ route('corporatemulticontest.user.view', $contest->slug) }}">Preview
                                                Contest on Quickvote <i class="ri-external-link-fill"></i></a></p>
                            ...
                            <div class="row">
                                @foreach ($com as $co)
                                    <div class="col-md-6">
                                        ...
                                        <h5>{{ $co->name }}</h5>
                                        <h3><a target=""
                                                href="{{ route('corporatemulticontestant.edit', $co->id) }}"><button
                                        ...
                                        <h3><a id="delete"
                                                href="{{ route('corporatemulticontestant.delete', $co->id) }}"><button
