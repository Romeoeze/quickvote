...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | QuickVote - Admin & Dashboard </title>
    ...
    <link href="{{ asset('backend/assets/css/new.css') }}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group mb-3 text-center row mt-3 pt-1">
                                <div class="col-12">
                                    <button class="btn btn-warning w-100 waves-effect waves-light" type="submit">Log
                                        In</button>
                                </div>
                            </div>
